...
namespace Emarwsdl.Controllers
{
    public class getAccountInfoController : ApiController
    {
        ...
        {
            return Ok("Method get execute");
        }
        [HttpPost]
        public IHttpActionResult getAcc(getAccountInfo_obj _obj)
        {
            string sjson = ""; 
        string msgCode = "00";
        string msg = "";
        ...
        sjson = JsonConvert.SerializeObject(_obj.data); 
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                cmd.CommandText = "sp_WSDL_getAccountInfo";
